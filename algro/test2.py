...
x_train, x_test, y_train, y_test = \
    sklearn.model_selection.train_test_split(x_old.iloc[0:1000], y_old.iloc[0:1000], test_size = 0.5)
# %%
# Metrics
...
parameters_result.to_csv("test/3.csv", index = True)
scores_result.to_csv("test/4.csv", index = False)
