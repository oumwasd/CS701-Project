...
result_f1 <- tibble::tibble::as_tibble(purrr::map(result_all, purrr::chuck("F1")))
result_auc <- tibble::tibble::as_tibble(purrr::map(result_all, purrr::chuck("AUC")))
result_h <- tibble::tibble::as_tibble(purrr::map(result_all, purrr::chuck("H-measure")))
result_ks <- tibble::tibble::as_tibble(purrr::map(result_all, purrr::chuck("KS_score")))
result_brier <- tibble::tibble::as_tibble(purrr::map(result_all,
    purrr::chuck("Brier_score")))
result_log <- tibble::tibble::as_tibble(purrr::map(result_all,
...
pairwise_result_f1 <- tibble::as_tibble(pairwise_f1$corrected.pval, rownames = NA)
## AUC
omnibus_auc <- scmamp::imanDavenportTest(result_auc)
pairwise_auc <- scmamp::postHocTest(result_auc,
    test = "aligned ranks", correct = "rom")
pairwise_result_auc <- tibble::as_tibble(pairwise_auc$corrected.pval, rownames = NA)
## H-measure
omnibus_h <- scmamp::imanDavenportTest(result_h)
pairwise_h <- scmamp::postHocTest(result_h,
    test = "aligned ranks", correct = "rom")
pairwise_result_h <- tibble::as_tibble(pairwise_h$corrected.pval, rownames = NA)
## KS_score
omnibus_ks <- scmamp::imanDavenportTest(result_ks)
pairwise_ks <- scmamp::postHocTest(result_ks,
    test = "aligned ranks", correct = "rom")
pairwise_result_ks <- tibble::as_tibble(pairwise_ks$corrected.pval, rownames = NA)
## Brier_score
omnibus_brier <- scmamp::imanDavenportTest(result_brier)
pairwise_brier <- scmamp::postHocTest(result_brier,
    test = "aligned ranks", correct = "rom")
pairwise_result_brier <- tibble::as_tibble(pairwise_brier$corrected.pval, rownames = NA)
## Log_loss
omnibus_log <- scmamp::imanDavenportTest(result_log)
pairwise_log <- scmamp::postHocTest(result_log,
    test = "aligned ranks", correct = "rom")
pairwise_result_log <- tibble::as_tibble(pairwise_log$corrected.pval, rownames = NA)
...
pairwise_f1_ns <- scmamp::postHocTest(result_f1[non_smote],
    test = "aligned ranks", correct = "rom")
pairwise_result_f1_ns <- tibble::as_tibble(pairwise_f1_ns$corrected.pval, rownames = NA)
## AUC non SMOTE
...
pairwise_h_ns <- scmamp::postHocTest(result_h[non_smote],
    test = "aligned ranks", correct = "rom")
pairwise_result_h_ns <- tibble::as_tibble(pairwise_h_ns$corrected.pval, rownames = NA)
## KS_score non SMOTE
omnibus_ks_ns <- scmamp::imanDavenportTest(result_ks[non_smote])
pairwise_ks_ns <- scmamp::postHocTest(result_ks[non_smote],
    test = "aligned ranks", correct = "rom")
pairwise_result_ks_ns <- tibble::as_tibble(pairwise_ks_ns$corrected.pval, rownames = NA)
...
pairwise_f1_s <- scmamp::postHocTest(result_f1[smote],
    test = "aligned ranks", correct = "rom")
pairwise_result_f1_s <- tibble::as_tibble(pairwise_f1_s$corrected.pval, rownames = NA)
## AUC SMOTE
omnibus_auc_s <- scmamp::imanDavenportTest(result_auc[smote])
pairwise_auc_s <- scmamp::postHocTest(result_auc[smote],
    test = "aligned ranks", correct = "rom")
pairwise_result_auc_s <- tibble::as_tibble(pairwise_auc_s$corrected.pval, rownames = NA)
## H-measure SMOTE
omnibus_h_s <- scmamp::imanDavenportTest(result_h[smote])
pairwise_h_s <- scmamp::postHocTest(result_h[smote],
    test = "aligned ranks", correct = "rom")
pairwise_result_h_s <- tibble::as_tibble(pairwise_h_s$corrected.pval, rownames = NA)
## KS_score SMOTE
omnibus_ks_s <- scmamp::imanDavenportTest(result_ks[smote])
pairwise_ks_s <- scmamp::postHocTest(result_ks[smote],
    test = "aligned ranks", correct = "rom")
pairwise_result_ks_s <- tibble::as_tibble(pairwise_ks_s$corrected.pval, rownames = NA)
## Brier_score SMOTE
